...
def parse_args():
    ...
    parser.add_argument("--epochs_regression", type=int, default=2, help="Number of epochs for regression training")
    parser.add_argument("--epochs_gating", type=int, default=2, help="Number of epochs for gating network training")
