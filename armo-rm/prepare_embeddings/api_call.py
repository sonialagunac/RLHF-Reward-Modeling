...
labeling_script = "data_generation_vllm.py"

def main():

    server_log_path = f"/cluster/work/vogtlab/Group/slaguna/logs/server_phi_log_batch_{args.batch_index}.txt"
    labeling_log_path = f"/cluster/work/vogtlab/Group/slaguna/logs/labeling_phi_log_batch_{args.batch_index}.txt"
